...
APP_VERSION = "v2.5.1"
LAST_UPDATED = "Dec 23, 2025 - 2:55 PM PST - Fix text sanitization"
...
st.markdown('<div class="hero"><p class="eyebrow">BC Environmental Funding</p><h1>EcoProject Navigator</h1><p style="color:var(--muted);margin-top:8px;">Match your project to funding opportunities</p><div class="pill" style="margin-top:12px;"><span class="dot"></span>Smart keyword matching · Deep analysis</div></div>', unsafe_allow_html=True)
